...
class User {
    constructor(user) {
        ...
        this.edge_felix_video_timeline = new InstagramVideo_1.InstagramVideo(user.edge_felix_video_timeline);
        this.edge_owner_to_timeline_media = new InstagramTimelineMediaPicture_1.InstagramTimelineMediaPicture(user.edge_owner_to_timeline_media);
    }
    get getAgentType() {
